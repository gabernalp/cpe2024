...
class UsersApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new UserResource(User::with(['documenttype', 'department', 'city', 'devices', 'roles', 'profile'])->get());
    }
    ...
    public function show(User $user)
    {
        ...
        return new UserResource($user->load(['documenttype', 'department', 'city', 'devices', 'roles', 'profile']));
    }
