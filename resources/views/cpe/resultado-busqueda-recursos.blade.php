...
<div class="container pt-5 pb-2">
    ...
    <div class="row pb-4 align-items-center">
        <div class="col-md-6">
			...
			<p class="pt-4">Palabra clave o frase de búsqueda: <em><strong>{{$sterm}}</strong></em></p>
        </div>
        <div class="col-md-5 ">
	...
	<div class="row align-items-stretch">
        ...
        @endphp
            ...
            <div class="col-md-2 mb-2"  id="myResource{{$resource->id}}">
                <p style="min-height:160px">@if($resource->image_pdf)
            ...
            @else
            <div class="col-md-2 mb-2" id="myResource{{$resource->id}}">
                <p class="text-center" style="min-height:160px"><a target="_blank" href="{{ $resource->link }}"><img title="{{$resource->comments}}" src="/images/link.png" class="img-fluid" alt=""></a></p>
...
<div class="jumbotron mt-1 mb-0 bgw">
    <div class="container">
        ...
        <p>Encuentra más recursos disponibles a los que puedes acceder:</p><hr />
        <div class="row">
            @foreach($resourceRands as $resource)
                ...
                <div class="col-md-2 mb-2" id="myResource{{$resource->id}}">
                    <p style="min-height:160px">@if($resource->image_pdf)
                        ...
                        @endif</p>
                    <p class="text-center"><i class="fa fa-download"></i> <small>Descargar</small></a></p><p><a target="_blank" href="{{ $resource->file->getUrl() }}"><small style="color: gray">{{ $resource->name }}</small></a><br />
                    @if($resource->manual)
                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-download"></i> Guia adicional</button></p>
                    <!-- Modal -->
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    $("#favorite{{$resourceId}}").click(function(){
      ...
      alert('Debes ser un usuario registrado y estar logueado para guardar registros en tu biblioteca');
