...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.background-processes.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('especial') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="especial" id="especial" value="1" {{ old('especial', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('descripcion_especial') ? 'is-invalid' : '' }}" name="descripcion_especial" id="descripcion_especial">{{ old('descripcion_especial') }}</textarea>
