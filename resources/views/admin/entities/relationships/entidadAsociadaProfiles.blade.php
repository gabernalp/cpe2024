...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-entidadAsociadaProfiles">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($profiles as $key => $profile)
                        <tr data-entry-id="{{ $profile->id }}">
                            ...
                            <td>
                                @foreach($profile->coursehooks as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-entidadAsociadaProfiles:not(.ajaxTable)').DataTable({ buttons: dtButtons })
