...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.closeImage.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.close-images.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input required class="form-control {{ $errors->has('answered_challenges') ? 'is-invalid' : '' }}" type="number" name="answered_challenges" id="answered_challenges" value="{{ old('answered_challenges', '') }}" step="1">
