...
@can('course_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-info" href="{{ route('admin.courses.hide') }}">
                @if(env('CICLOS') == 'encendido') Ocultar del menú principal @else Mostrar sección en menú principal @endif
            </a>
        </div>
    </div>
@endcan
                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Course::TIPO_CICLO_SELECT as $key => $item)
...
{ data: 'id', name: 'id' },
{ data: 'tematica_asociada_name', name: 'tematica_asociada.name' },
{ data: 'name', name: 'name' },
{ data: 'tipo_ciclo', name: 'tipo_ciclo' },
{ data: 'unico', name: 'unico' },
{ data: 'additional_comments', name: 'additional_comments' },
