...
<html lang="en">
  <head>
    ...
    <script src="{{ asset('js/front/5dc959b07a.js') }}" crossorigin="anonymous"></script>
	...
	<meta property="og:url" content="{{env('APP_UR')}}">
    ...
    <script src="{{ asset('js/front/bootstrap3-typeahead.min.js') }}"></script>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-center">@if(session('message')){!!session('message')!!}@else{!!@$message!!}@endif</p>
                </div>
                @if(session('share'))
...
@yield("content")
	...
	<script src="{{ asset('js/front/perfect-scrollbar.min.js') }}" ></script>
	<script src="{{ asset('js/front/jszip.min.js') }}" ></script>
	<script src="{{ asset('js/front/moment.min.js') }}" ></script>
	<script src="{{ asset('js/front/bootstrap-datetimepicker.min.js') }}" ></script>
	<script src="{{ asset('js/front/select2.full.min.js') }}" ></script>
