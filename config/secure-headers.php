...
return [
    ...
    'server' => 'Internet Information Services (Verion 10.0.14393.0)',
    ...
    'csp' => [
        ...
        'script-src' => [
            ...
            'allow' => [
                ...
                $protocol.'googletagmanager.com',
                $protocol.'google-analytics.com',
				$protocol.'kit.fontawesome.com',
				$protocol.'cdnjs.cloudflare.com',
				$protocol.'www.googletagmanager.com',
				$protocol.'static.addtoany.com',
				$protocol.'static.getbutton.io'
